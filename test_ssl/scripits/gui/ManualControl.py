...
class ManualControl:
    ...
    def update(self):
        ...
        if pygame.K_k in self.keys_pressed:
            ...
            self.robot.__sendCommand(0, 0, self.rotationalSpeed, False)
