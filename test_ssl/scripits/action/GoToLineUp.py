...
class GoToLineUp(Behaviour):
    ...
    def __calculate_lineup_point(self) -> tuple:
        L_vec: tuple = (self.ball.getPosition()[0] - self.target_robot.getPosition()[0], self.ball.getPosition()[1] - self.target_robot.getPosition()[1])
