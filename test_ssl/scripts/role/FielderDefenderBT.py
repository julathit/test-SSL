...
class FielderDefenderBT(Selector):
    def __init__(self, robot: Robot):
        super(FielderDefenderBT, self).__init__("Fielder Defender BT", False)
        self.robot = robot
...
class FielderDefenderIfCanShootBT(Sequence):
    def __init__(self, robot: Robot):
        super(FielderDefenderIfCanShootBT, self).__init__("Fielder Defender Selector", True)
        self.add_children([checkIfBallInZone(robot), FielderDefenderRobotShootToFront(robot)])

class checkIfBallInZone(Behaviour):
    def __init__(self, robot: Robot):
        super(checkIfBallInZone, self).__init__("check If Ball is in Defender Zone")
